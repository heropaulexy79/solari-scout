# Website Audit Report: www.lbs.edu.ng

**Target URL:** https://www.lbs.edu.ng/  
**Audit Date:** Tue, 01 Sep 2026 11:10:32 GMT  
**Pages Analyzed:** 1  
**Links Tested:** 2  
...
Solari Scout completed an automated web audit of **https://www.lbs.edu.ng/**.
...
- **URL:** `https://www.lbs.edu.ng/broken-link`
- **Category:** navigation (DETERMINISTIC)
- **Description:** Link "Broken Page" on https://www.lbs.edu.ng/ resolved with failure status (404).
- **Recommendation:** Fix or remove broken URL reference at source page https://www.lbs.edu.ng/.
- **Evidence:** ```json
{
  "status": 404,
  "outcome": "NOT_FOUND",
  "sourcePage": "https://www.lbs.edu.ng/",
...
- **Description:** 1 out of 3 images on https://www.lbs.edu.ng/ lack alt text.
...
| URL | Status | Title |
| :--- | :---: | :--- |
| `https://www.lbs.edu.ng/` | 200 | Sample Title for www.lbs.edu.ng |
...
| :--- | :--- | :---: | :--- |
| `https://www.lbs.edu.ng/` | `About Us` | 200 | PASS |
| `https://www.lbs.edu.ng/` | `Broken Page` | 404 | NOT_FOUND |
...
1. **[HIGH] Broken internal link (NOT_FOUND)**: Fix or remove broken URL reference at source page https://www.lbs.edu.ng/.
